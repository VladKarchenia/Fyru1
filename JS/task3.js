...
for (let num = 1; num <=100; num++) {
  num % 3 === 0 && num % 5 === 0 ? console.log(`${num} FizzBuzz`) : (num % 3 === 0 ? console.log(`${num} Fizz`) : (num % 5 === 0 && num % 3 !== 0 ? console.log(`${num} Buzz`) : console.log(num)))
}
...
const reducers = arrays => arrays.reduce((acc, cur) => acc.concat(cur))
